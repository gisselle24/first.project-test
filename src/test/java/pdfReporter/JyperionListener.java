...
public class JyperionListener implements ITestListener {
	...
	private String pdfPath = System.getProperty("user.dir") + File.separator + "\\Reportes_PDF\\" + File.separator
			+ (new Random().nextInt());	
	/**
	 * PdfPTables
	 */
	...
	public void onTestFailure(ITestResult result) {
		...
		String file = System.getProperty("user.dir") + "\\ScreenShots\\" + (new Random().nextInt()) + ".png";
		try {
			BaseClass.screenShot(file);
		} catch (Exception e) {
	...
	public void onStart(ITestContext context) {
		log("onStart(" + context + ")");
		try {
			PdfWriter.getInstance(this.document, new FileOutputStream(pdfPath + context.getName() + ".pdf"));
		} catch (Exception e) {
			e.printStackTrace();
		}
		this.document.open();
