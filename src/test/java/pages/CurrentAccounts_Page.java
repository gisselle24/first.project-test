...
public class CurrentAccounts_Page extends BaseClass {
	...
	By locatorOut = MobileBy.xpath("//android.widget.TextView[@text='Cuentas corrientes (Personas naturales)']");
	By locatorIn = MobileBy.xpath("//android.widget.TextView[@text='Cuentas corrientes (Personas naturales)']");

	public CurrentAccounts_Page(AndroidDriver driver) {
		super(driver);
	...
	public Boolean isCurrentAccountsPagOpeningWell() {
